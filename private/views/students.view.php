        ...
        <div class="container-fluid p-3 shadow mx-auto" style="max-width: 1000px; background-color:#987 !important;">
         <?php  $this->view('includes/crumbs', ['crumbs'=>$crumbs])?>
            ...
            <nav class="navbar bg-light">
                ...
                <a href="<?=ROOT?>/signup?mode=students"><button class=" btn btn-sm btn-primary"><i class="fa fa-plus"></i>Add New</button></a>
        ...
        <div class="card-group justify-content-center">
            ...
            <div class="card m-2 shadow-sm" style="max-width: 12rem; min-width:10rem;">
             ...
             <div class="card-body">
               ...
               <?php  endforeach; ?>
            <?php  else:; ?>
            <h4>No students data available at the momment!!</h4>
            <?php  endif; ?>
        </div>
